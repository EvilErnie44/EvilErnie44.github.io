...
abstract class spaceMarine {
        private name:string;
        private enlist: number;
        private death?: number;
        private service?: number;

        constructor(theName:string, enlist:number, yearOfDeath: number, service: number){
          this.name = theName;
          this.enlist = enlist;
        ...
        timerServFunc(name:string, service: number, enlist: number, death?:number) {
...
/*
var newmarine = new spaceMarine("jamal", 1400, 3200);
undefined
newmarine.death;
3200
newmarine.timerServFunc();
*/  
